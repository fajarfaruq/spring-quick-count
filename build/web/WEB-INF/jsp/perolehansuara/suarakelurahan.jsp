<div id="breadcumb">
    <h4>Perolehan Suara > Kelurahan</h4>
    <br />
</div>
    ...
    $(function() {
        $('#dg').datagrid({
            ...
            onExpandRow: function(index, row) {
                ...
                $('#ddv-' + index).datagrid({
                    url: '${pageContext.request.contextPath}/perolehansuara/kelurahan/tampildetail/' + row.kodekelurahan,
                    fitColumns: true,
                    singleSelect: true,
                    rownumbers: true,
                    loadMsg: '',
...
<div class="manajemendata">
    <table id="dg" class="easyui-datagrid" 
           url="${pageContext.request.contextPath}/perolehansuara/kelurahan/tampil" toolbar="#tb"
