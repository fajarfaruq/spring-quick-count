<div id="breadcumb">
    <h4>Perolehan Suara > Kecamatan</h4>
    <br />
</div>
    ...
    $(function() {
        $('#dg').datagrid({
            ...
            onExpandRow: function(index, row) {
                ...
                $('#ddv-' + index).datagrid({
                    url: '${pageContext.request.contextPath}/perolehansuara/kecamatan/tampildetail/' + row.kodekecamatan,
                    fitColumns: true,
                    singleSelect: true,
                    rownumbers: true,
                    loadMsg: '',
...
<div class="manajemendata">
    <table id="dg" class="easyui-datagrid" 
           url="${pageContext.request.contextPath}/perolehansuara/kecamatan/tampil" toolbar="#tb"
           singleSelect="true" pagination="true" fitColumns="true" fit="true">
        <thead>
            <tr>
                <th field="namakecamatan" width="60">Kecamatan</th>
                <th field="jumlahdpt" width="60">Jumlah DPT</th>
