...
<script type="text/javascript">
    ...
    function newUser() {
        ...
        $('#fm').form('clear');
        url = '${pageContext.request.contextPath}/user/userhelpdesk/tambah';
    }
    function editUser() {
        ...
        if (row) {
            ...
            $('#fms').form('load', row);
            url = '${pageContext.request.contextPath}/user/userhelpdesk/edit';
        }
    }
    ...
    function removeUser() {
        ...
        if (row) {
            $.messager.confirm('Konfirmasi', 'Apakah anda yakin akan menghapus user kelurahan tersebut?', function(r) {
                if (r) {
                    $.post('${pageContext.request.contextPath}/user/userhelpdesk/hapus', {id: row.username}, function(result) {
                        if (result.success) {
                            $('#dg').datagrid('reload');	// reload the user data
                        } else {
    ...
    <div class="manajemendata">
        ...
        <table id="dg" class="easyui-datagrid" 
               url="${pageContext.request.contextPath}/user/userhelpdesk/tampil"
               toolbar="#tb"
