<div id="breadcumb">
    <h4>Perolehan Suara > Hasil Akhir</h4>
 <br />
    <a href="javascript:poptastic('${pageContext.request.contextPath}/perolehansuara/kecamatan/print');" class="easyui-linkbutton" data-options="iconCls:'icon-print'">Cetak</a>
    <br />
</div>
<br/>
...
<hr>
    ...
    <div class="manajemendata">  
        <table id="dg" class="easyui-datagrid" title="Detail Perolehan Pasangan Calon"
               url="${pageContext.request.contextPath}/perolehansuara/semua/tampil" 
