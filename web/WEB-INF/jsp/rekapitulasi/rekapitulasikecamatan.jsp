    ...
    $(function() {
        $('#dg').datagrid({
            ...
            onExpandRow: function(index, row) {
                ...
                $('#ddv-' + index).datagrid({
                    url: '${pageContext.request.contextPath}/rekapitulasi/kecamatan/tampildetail/' + row.kodekecamatan,
                    fitColumns: true,
                    singleSelect: true,
                    rownumbers: true,
                    loadMsg: '',
...
<div class="manajemendata">
    <table id="dg" class="easyui-datagrid" 
           url="${pageContext.request.contextPath}/rekapitulasi/kecamatan/tampil" toolbar="#tb"
